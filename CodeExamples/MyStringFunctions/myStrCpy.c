...
int main(void) {
    ...
    #define SIZE 8
    {
        char s[SIZE] = "abcdef";     // source
        char mycpy[SIZE]="ABCDEFG";  // destination used by my_strncpy
        char stdcpy[SIZE]="ABCDEFG"; // destination used by strncpy
        int  n = 4;
        ...
        printf("\n");
        printf("Vergleich: my_strncpy versus strncpy\n");
        printf("Zielzeichenkette mycpy zu Beginn: %s\n", mycpy);
        printf("\n");
        ...
        printf("Index         src        my_strcpy        standard\n");
        int i;
        for (i = 0; i < SIZE; i++) {
