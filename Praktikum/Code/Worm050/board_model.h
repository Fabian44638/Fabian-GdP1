...
// ============================================================================
//  Strukturtyp für Positionen auf dem Spielfeld
//
//  Viele Funktionen im Programm arbeiten mit Koordinatenpaaren (y, x).
//  Bisher wurden diese oft als zwei separate int-Parameter übergeben.
//  Mit dieser Struktur fassen wir beide Werte logisch zusammen.
//
//  Vorteile:
//   - übersichtlichere Funktionssignaturen
//   - leichteres Weiterreichen und Speichern von Positionen
//   - bessere Grundlage für spätere Erweiterungen (z.B. zusätzliche Infos)
//
//  Die Struktur wird insbesondere vom Wurm-Modul (worm_model) benutzt,
//  um die einzelnen Segmente des Wurms zu verwalten.
// ============================================================================

struct pos {
    int y;  // Zeilenindex (vertikale Position)
    int x;  // Spaltenindex (horizontale Position)
};
...
//
//  Hinweis für spätere Aufgabenblätter (z.B. Message Area):
//   getLastRow() kann so angepasst werden, dass einige untere Zeilen
//   für Statusmeldungen reserviert bleiben. Der Rest des Programms
//   muss dann nur diese Getter benutzen und nicht direkt LINES/COLS.
// ============================================================================
